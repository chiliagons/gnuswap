...
import { Button, Title, Card, Text, Select, Divider, TextField } from '@gnosis.pm/safe-react-components';
    ...
    <>
      <Container>
        <Card>
          ...
          <Divider />
          <Button size="lg" iconType="resync" color="primary" variant="contained" onClick={() => setShowModal(true)}>
