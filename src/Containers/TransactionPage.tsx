...
import { Table, TableHeader, TableRow, Divider, Icon, IconText, TableAlignment, EthHashInfo } from '@gnosis.pm/safe-react-components';
...
const TransactionPage: React.FC = () => {
  ...
  const headerCells:TableHeader[] = [{"id":"sender", "label":"Sender Address"}, {"id":"receiverAddress", "label":"Receiver Address"}, {"id":"status", "label":"Status"}, {"id":"retry", alignment: TableAlignment.right , "label":"Retry"}, ];
